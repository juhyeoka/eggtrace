...
<body>
<div class="page">
  <div class="topbar"><div class="brand">JCR</div></div>
    
  </div>

  <div class="hero-grid">
    <div class="card hero-copy-card">
      <div class="hero-badge">✦ JCR Farm Story</div>
      ...
      <a href="https://www.instagram.com/eyeran_egg?igsh=cmtzaDliN3Nhdzdt&utm_source=qr" target="_blank" class="hero-cta">✦ JCR 인스타그램</a>
      <div class="hero-note">이번주 농장 기록, 최근 흐름, 변화 요약까지 한 화면에서 편하게 확인할 수 있어요. 보고 고르는 경험이 JCR 핵심입니다 ✨</div>
    </div>
  ...
  <div class="lower-grid">
    ...
    <div>
      <div class="card subscribe-card">
        ...
        <a href="https://www.instagram.com/eyeran_egg?igsh=cmtzaDliN3Nhdzdt&utm_source=qr" target="_blank" class="cta">JCR 인스타그램</a>
      </div>
