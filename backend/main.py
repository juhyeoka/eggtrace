...
<div class="page">
  ...
  <div class="hero-grid">
    <div class="card hero-copy-card">
      ...
      <a href="https://www.instagram.com/naran_egg?igsh=cmtzaDliN3Nhdzdt&utm_source=qr" target="_blank" class="hero-cta">✦ EyeRan 인스타그램</a>
  ...
  <div class="lower-grid">
    ...
    <div>
      <div class="card subscribe-card">
        ...
        <p class="subscribe-copy">농장을 직접 확인한 계란이니까, 믿고 꾸준히 드실 수 있어요. 정기배송으로 신청하면 매번 주문할 필요 없이 신선한 EyeRan이 정해진 날에 집 앞에 옵니다.</p>
        <a href="https://www.instagram.com/naran_egg?igsh=cmtzaDliN3Nhdzdt&utm_source=qr" target="_blank" class="cta">EyeRan 인스타그램</a>
      </div>
